...
namespace FIMSpace.FProceduralAnimation
{
    public partial class LegsAnimator
    {
        public partial class HipsReference
        {
                ...
                if (Owner.StabilizeCenterOfMass > 0f)
                {
                    ...
                    if (Owner.StabilityAlgorithm == EStabilityMode.Biped_Deprecated)
                    {
                        for (int l = 0; l < ChildLegs.Count; l++)
                        {
                            ...
                            initRefPose.y += Hips_LastHipsOffset;
                            ...
                            target.y *= 0.25f;
                            stabilityDiff += stabilizingMultiplier * Owner.StabilizeCenterOfMass * 0.5f * leg.BlendWeight * target;
                        }
                    ...
                    else if (Owner.StabilityAlgorithm == EStabilityMode.Universal)
                    {
                        ...
                        for (int l = 0; l < ChildLegs.Count; l++)
                        {
                            ...
                            target.y *= 0.25f;
                            stabilityDiff += stabilizingMultiplier * Owner.StabilizeCenterOfMass * leg.BlendWeight * target / legsDiv;
                        }
            ...
            public float Hips_LastHipsOffset { get; private set; } = 0f;
            /// <summary> Not blended height offset </summary>
            public float Hips_StepHeightAdjustOffset { get; private set; } = 0f;
            ...
            public Vector3 PreHipsAdjustPosition { get; internal set; }
            ...
            void AnimateStepAdjustTo(float yOffset)
            {
                ...
                {
                    Hips_StepHeightAdjustOffset = yOffset;
                    return;
                }
                ...
                if (Owner.HipsAdjustStyle == EHipsAdjustStyle.FollowLegHeight)
                    if (yOffset < Hips_StepHeightAdjustOffset)
                    {
                ...
                Hips_StepHeightAdjustOffset = Mathf.SmoothDamp(Hips_StepHeightAdjustOffset,
            ...
            public float CalculateBodyAdjust()
            {
                ...
                Hips_LastHipsOffset = Hips_StepHeightAdjustOffset * Owner.baseTransform.lossyScale.y * hipsWeight;
                return Hips_LastHipsOffset;
            }

...
namespace FIMSpace.FProceduralAnimation
{
    public partial class LegsAnimator
    {
        ...
        void HipsHubs_ApplyDetailed(HipsReference hub)
        {
            ...
            hubOffset += _MainBlendPlusGrounded * HipsStretchPreventer * stabilizingMultiplier * stretchPreventer;
            ...
            if (HipsSetup.Hips_LastHipsOffset > 0f) extraAdjustHelper.y -= HipsSetup.Hips_LastHipsOffset * 0.1f;
            if (hub.Hips_LastHipsOffset < 0f) extraAdjustHelper.y += hub.Hips_LastHipsOffset * 0.1f;

...
namespace FIMSpace.FProceduralAnimation
{
    public partial class LegsAnimator
    {
        ...
        public class Variable
        {
            ...
            {
                if (o is int v1) { _value = new Vector4(v1, 0, 0, 1); VariableType = EVariableType.Number; }
                else if (o is float v2) { _value = new Vector4(v2, 0, 0, 0); VariableType = EVariableType.Number; }

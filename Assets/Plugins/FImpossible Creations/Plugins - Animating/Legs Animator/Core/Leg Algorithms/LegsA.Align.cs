    ...
    public partial class LegsAnimator
    {
        public partial class Leg
        {
            ...
            void AlignStep_CheckAlignStatePre()
            {
                ...
                if (RaycastHitted)
                {
                    float hipsHelp = ParentHub.Hips_StepHeightAdjustOffset;
            ...
            void AlignStep_LegElevation()
            {
                ...
                float heightInGroundAlign = GroundHitRootSpacePos.y - A_LastSuddenSmoothYOffset - ParentHub.Hips_StepHeightAdjustOffset;
